...
> Đối chiếu với todo.schema.json: phases, dependencies, blockers, prerequisites, handoff ready_condition.

---

## 1. YAML Frontmatter — todo-schema.json Required Fields

- [ ] `skill_schema_version: "3.1.0"` present
...
- [ ] Confidence score >= 70 với weighted breakdown được ghi nhận
- [ ] All trace tags valid (AH1-AH5 compliance)
- [ ] Token budget ở mức Green/Yellow (< 80% context window)

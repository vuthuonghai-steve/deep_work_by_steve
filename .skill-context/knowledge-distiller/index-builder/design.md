...
- **Tác vụ**: Tổng hợp kết quả, biên dịch và sinh/cập nhật tệp chỉ mục điều hướng llms.txt và đồng bộ hóa ngữ cảnh.

### B. Vai trò trong Orchestration Flow
[TỪ EXPLORATION §5]
Quy hoạch khuyến nghị phân vùng Zones ban đầu: Core (SKILL.md), Scripts (scripts/build_index.py), Data (data/llms.txt), Loop (loop/checklist.md)

## 2. Capability Map

[TỪ EXPLORATION §3.3 & §4]
- **Nhiệm vụ nghiệp vụ chính**: Tổng hợp kết quả, biên dịch và sinh/cập nhật tệp chỉ mục điều hướng llms.txt và đồng bộ hóa ngữ cảnh.

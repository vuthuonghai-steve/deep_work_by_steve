# Quy Tắc Elicitation & Master Prompt Architecture — BA Elicitor

> Nguồn tổng hợp: [`thong-tin-mau.md`](file:///home/steve/Work-space/deep_work_by_steve/.skill-context/skill-business-analyst/resources/thong-tin-mau.md) + [`raw2.md`](file:///home/steve/Work-space/deep_work_by_steve/.skill-context/skill-business-analyst/resources/raw2.md)
...
Nguồn: `thong-tin-mau.md` — Chuỗi Lập Luận Đồng Bộ Và Prompting Toàn Diện

## 5. 3-Layer Mapping Table (từ raw2.md)
...
Nguồn: `raw2.md` — Bảng LĨNH VỰC 1, 2, 3

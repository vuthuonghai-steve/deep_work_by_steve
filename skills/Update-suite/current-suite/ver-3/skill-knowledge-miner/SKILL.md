...
- Input Contract: `.skill-context/{skill-name}/resources/` containing raw docs + Stage 0's `exploration.md`
- Output Contract: `knowledge/domain-handbook.md` containing highly structured implementation standards
...
- **Tier 2 (Conditional)**:
  - `.skill-context/{skill-name}/exploration.md` (Load when: analyzing business requirements)
  - `.skill-context/karpathy-standards.md` (Load when: enforcing 'Discipline-Honesty-Creativity' guardrails)
- **Tier 3 (On-Demand)**:
...
1. Quét toàn bộ tệp tin trong `.skill-context/{skill-name}/resources/`.
...
1. Tạo tệp `domain-handbook.md` dưới thư mục `knowledge/` của Kỹ năng mới.

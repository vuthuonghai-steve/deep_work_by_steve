...
- [references/rules/](references/rules/) - 40+ detailed rule files organized by category:
  - [references/rules/async-defer-await.md](references/rules/async-defer-await.md) - Defer await until needed
  - [references/rules/async-parallel.md](references/rules/async-parallel.md) - Promise.all() parallelization
  - [references/rules/bundle-dynamic-imports.md](references/rules/bundle-dynamic-imports.md) - Dynamic imports
  - [references/rules/bundle-barrel-imports.md](references/rules/bundle-barrel-imports.md) - Avoid barrel imports
  - [references/rules/server-parallel-fetching.md](references/rules/server-parallel-fetching.md) - Server parallel fetching
  - [references/rules/rerender-memo.md](references/rules/rerender-memo.md) - React.memo optimization
  - [references/rules/rendering-content-visibility.md](references/rules/rendering-content-visibility.md) - Content visibility
  - And 30+ more rules in references/rules/

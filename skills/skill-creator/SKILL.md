...
- [research-upgrade-report.md](research-upgrade-report.md) - Skill upgrade research

### Tier 3: Optional (load when needed)
- @.claude/skills/skill-creator/scripts/init_skill.py - Skill initialization script
- @.claude/skills/skill-creator/scripts/quick_validate.py - Quick validation script
- @.claude/skills/skill-creator/scripts/package_skill.py - Skill packaging script
